...
const emailIcon = (
  ...
  >
    ...
    ></path>
    <g fill="#BEA782">
      <path d="M82.5 67.9c-.2.6-.4 1.1-.5 1.6-6.6-6.5-13.1-13-19.6-19.5 6.6-6.5 13.1-13 19.7-19.5.1.4.3 1 .5 1.5-.1 12-.1 24-.1 35.9zM79.2 27.7l-2.8 2.8C68.2 38.7 60 46.9 51.8 55.2c-1.1 1.2-2.4 1.2-3.5 0-9-9-18-18-26.9-27l-.5-.5c.8-.2 1.4-.3 2-.4H76.5c.8-.2 1.7-.1 2.7.4z"></path>
      <path d="M59.5 52.8c6.5 6.5 13.1 12.9 19.7 19.5-.8.2-1.4.3-2.1.5H23.6c-.9 0-1.8-.1-2.7-.5 6.6-6.5 13.1-13 19.6-19.4 1.6 1.6 3.4 3.4 5.2 5.1 1.9 1.9 4.6 2.4 6.9 1.2.7-.3 1.3-.8 1.8-1.3 1.6-1.5 3.1-3.1 4.7-4.7.2-.1.3-.3.4-.4zM18.1 30.5c6.5 6.5 13.1 13 19.6 19.4-6.6 6.5-13.1 13-19.7 19.5-.4-.7-.5-1.5-.5-2.5v-18-16c0-.8.2-1.6.6-2.4z"></path>
    </g>
  </svg>
);
...
const faxIcon = (
  ...
  >
    ...
    ></path>
    <g fill="#BEA782">
      <path d="M67.5 70v-.9-13.7c0-1.9-1-2.9-2.9-2.9H35.3c-1.8 0-2.8 1-2.8 2.9V70c-.2 0-.4.1-.6.1h-6.8c-4.3 0-7.6-3.3-7.6-7.6V42.7c0-4.3 3.3-7.6 7.6-7.6h49.7c4.4 0 7.6 3.3 7.6 7.6v19.8c0 4.3-3.3 7.6-7.6 7.6-2.3-.1-4.8-.1-7.3-.1zM70 42.5c-1.4 0-2.5 1.1-2.5 2.6 0 1.3 1.1 2.4 2.4 2.4 1.4 0 2.6-1.1 2.5-2.5.1-1.4-1-2.5-2.4-2.5zM67.5 32.5h-35v-3.4-6.3c0-1.6 1-2.7 2.7-2.7h29.6c1.7 0 2.7 1 2.7 2.7V32.5z"></path>
      <path d="M37.5 57.5h25V77c0 1.9-1 2.9-2.9 2.9H40.3c-1.9 0-2.8-1-2.8-2.8V57.5zm12.4 10h4.8c1.6 0 2.7-1 2.7-2.5 0-1.4-1.1-2.5-2.7-2.5h-9.6c-1.6 0-2.7 1.1-2.7 2.5s1.1 2.5 2.7 2.5h4.8zM50 70h-4.8c-1.5 0-2.6 1.1-2.7 2.5 0 1.4 1.1 2.5 2.6 2.5h9.8c1.5 0 2.6-1.1 2.6-2.5S56.4 70 54.8 70H50z"></path>
    </g>
  </svg>
);
...
const instagramIcon = (
  ...
  >
    ...
    ></path>
    <g fill="#BEA782">
      <path d="M50 27.5c7.3 0 8.2 0 11.1.2 2.7.1 4.1.6 5.1.9 1.3.5 2.2 1.1 3.2 2.1s1.6 1.9 2.1 3.2c.4 1 .8 2.4.9 5.1.1 2.9.2 3.8.2 11.1s0 8.2-.2 11.1c-.1 2.7-.6 4.1-.9 5.1-.5 1.3-1.1 2.2-2.1 3.2s-1.9 1.6-3.2 2.1c-1 .4-2.4.8-5.1.9-2.9.1-3.8.2-11.1.2s-8.2 0-11.1-.2c-2.7-.1-4.1-.6-5.1-.9-1.3-.5-2.2-1.1-3.2-2.1s-1.6-1.9-2.1-3.2c-.4-1-.8-2.4-.9-5.1-.1-2.9-.2-3.8-.2-11.1s0-8.2.2-11.1c.1-2.7.6-4.1.9-5.1.5-1.3 1.1-2.2 2.1-3.2s1.9-1.6 3.2-2.1c1-.4 2.4-.8 5.1-.9 2.9-.2 3.8-.2 11.1-.2m0-5c-7.5 0-8.4 0-11.3.2-2.9.1-4.9.6-6.7 1.3-1.8.7-3.3 1.6-4.9 3.2-1.5 1.5-2.5 3.1-3.2 4.9-.7 1.7-1.1 3.7-1.3 6.7-.1 2.9-.2 3.9-.2 11.3s0 8.4.2 11.3c.1 2.9.6 4.9 1.3 6.7.7 1.8 1.6 3.3 3.2 4.9 1.5 1.5 3.1 2.5 4.9 3.2 1.7.7 3.7 1.1 6.7 1.3 2.9.1 3.9.2 11.3.2 7.5 0 8.4 0 11.3-.2 2.9-.1 4.9-.6 6.7-1.3 1.8-.7 3.3-1.6 4.9-3.2 1.5-1.5 2.5-3.1 3.2-4.9.7-1.7 1.1-3.7 1.3-6.7.1-2.9.2-3.9.2-11.3s0-8.4-.2-11.3c-.1-2.9-.6-4.9-1.3-6.7-.7-1.8-1.6-3.3-3.2-4.9-1.5-1.5-3.1-2.5-4.9-3.2-1.7-.7-3.7-1.1-6.7-1.3-2.9-.2-3.8-.2-11.3-.2"></path>
      <path d="M50 35.9c-7.8 0-14.1 6.3-14.1 14.1S42.2 64.1 50 64.1 64.1 57.8 64.1 50 57.8 35.9 50 35.9m0 23.3c-5.1 0-9.2-4.1-9.2-9.2s4.1-9.2 9.2-9.2 9.2 4.1 9.2 9.2-4.1 9.2-9.2 9.2"></path>
      <path d="M68 35.3c0 1.8-1.5 3.3-3.3 3.3-1.8 0-3.3-1.5-3.3-3.3 0-1.8 1.5-3.3 3.3-3.3 1.8 0 3.3 1.5 3.3 3.3"></path>
    </g>
  </svg>
);
...
const whatsappIcon = (
  ...
  >
    ...
    <path
      ...
      d="M26.8 7.5c6.9-3.7 14.7-5.8 23.1-5.8 26.8 0 48.4 21.7 48.4 48.4 0 26.8-21.7 48.4-48.4 48.4S1.4 76.8 1.4 50.1c0-10.1 3.1-19.4 8.4-27.2 1.2-1.8 2.5-3.4 3.9-5"
    ></path>
    <g fill="#BEA782" fillRule="evenodd">
      <path d="M75 48.7C74.6 35.6 63.8 25 50.5 25 37.3 25 26.6 35.3 26 48.3v1.1c0 4.6 1.3 8.9 3.5 12.6L25 75l13.6-4.3c3.5 1.9 7.6 3 11.9 3C64 73.7 75 62.8 75 49.4v-.7zM50.5 69.8c-4.2 0-8.1-1.2-11.4-3.4L31.2 69l2.6-7.6c-2.5-3.4-3.9-7.5-3.9-12 0-.7 0-1.3.1-2 1-10.4 9.8-18.5 20.5-18.5 10.8 0 19.7 8.3 20.6 18.9 0 .5.1 1.1.1 1.6-.1 11.3-9.4 20.4-20.7 20.4z"></path>
      <path d="M61.7 54.3c-.6-.3-3.6-1.7-4.1-1.9-.6-.2-1-.3-1.4.3-.4.6-1.6 1.9-1.9 2.3-.4.4-.7.4-1.3.1-.6-.3-2.5-.9-4.8-3-1.8-1.6-3-3.5-3.3-4.1-.3-.6 0-.9.3-1.2.3-.3.6-.7.9-1 .1-.1.1-.2.2-.3.1-.2.2-.4.4-.7.2-.4.1-.7 0-1-.1-.3-1.4-3.2-1.9-4.4-.5-1.2-1-1-1.4-1-.3 0-.7-.1-1.1-.1-.4 0-1.1.1-1.6.7-.6.6-2.1 2-2.1 5 0 .7.1 1.4.3 2 .6 2.1 1.9 3.8 2.1 4.1.3.4 4.2 6.6 10.3 9 6.1 2.4 6.1 1.6 7.2 1.5 1.1-.1 3.6-1.4 4.1-2.8.5-1.4.5-2.6.4-2.8-.3-.3-.7-.4-1.3-.7z"></path>
    </g>
  </svg>
);
